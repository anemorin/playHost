        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "text", nullable: true, comment: "Никнейм пользователя"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "uuid_in(md5(random()::text || clock_timestamp()::text)::cstring)"),
                    Gender = table.Column<int>(type: "integer", nullable: true, comment: "Гендер"),
                    DateOfBirth = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, comment: "Дата рождения"),
                    PhoneNumber = table.Column<string>(type: "text", nullable: true, comment: "Номер телефона"),
                    Height = table.Column<int>(type: "integer", nullable: true, comment: "Рост"),
                    Weight = table.Column<int>(type: "integer", nullable: true, comment: "Вес"),
