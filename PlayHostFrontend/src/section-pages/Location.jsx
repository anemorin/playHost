      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="subtitle fadeInUp mb-3">Расположение серверов</div>
          </div>
          <div className="col-lg-6">
            <h2 className="fadeInUp mb20">
              25 серверов доступно по всему миру
            </h2>
          </div>
          <div className="col-lg-6">
            Воспользуйтесь нашим инструментом тестирования местоположения
            сервера, чтобы обеспечить оптимальную производительность. Поскольку
            ваши пользователи находятся в разных местах, важно определить
            местоположение сервера, которое обеспечит наилучший опыт для ваших
            пользователей. Наш тестер проверки связи может помочь вам определить
            идеальное расположение сервера для ваших конкретных нужд.
          </div>
      ...
      <div className="no-bottom wow fadeInRight d-flex z-1000">
        <div className="de-marquee-list wow">
          <div className="d-item">
            <span className="d-item-txt">Moscow</span>
